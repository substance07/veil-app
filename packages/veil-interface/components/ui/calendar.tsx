  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdowns: cn(
          "w-full flex items-center font-sans text-xs font-medium justify-center h-(--cell-size) gap-1.5",
          defaultClassNames.dropdowns
        ),
        dropdown_root: cn(
          "relative has-focus:border-ring rounded-lg border border-border shadow-sm has-focus:ring-ring/50 has-focus:ring-2",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-xs"
            : "pl-2 pr-1 flex items-center gap-1 text-xs h-8 [&>svg]:text-muted-foreground [&>svg]:size-3.5",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-muted-foreground flex-1 font-normal text-[0.6rem] font-sans select-none",
